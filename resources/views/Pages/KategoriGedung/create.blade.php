    ...
    <div class="container">
        <div class="card card-warning card-outline">
            <div class="card-header">
                <h3 class="card-title">Tambah Kategori Gedung</h3>
            ...
            <form action="{{ route('warehouseCategory.post') }}" method="POST">
                @csrf
                <div class="card-body">
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label">Kategori Gedung*</label>
                        <div class="col-md-4">
                            <input type="text" class="form-control" name="nama_kategori" placeholder="Kategori Gedung" required>
                        </div>
                    </div>
                    <div class="form-group row">
