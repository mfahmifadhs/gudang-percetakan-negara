                ...
                <table id="table-show" class="table table-bordered table-striped" style="font-size: 15px;">
                    ...
                    <tbody class="text-capitalize">
                        ...
                        <tr>
                            ...
                            <td class="pt-3">{{ $row->mainunit->nama_unit_utama }}</td>
                            <td class="pt-3">{{ $row->kode_unit_kerja }}</td>
                            ...
                            <td class="text-center">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item btn" type="button" href="{{ route('workunit.edit', $row->id_unit_kerja) }}">
                                        <i class="fas fa-edit"></i> Edit
                                    </a>
                                    <a class="dropdown-item btn" type="button" href="{{ route('workunit.delete', $row->id_unit_kerja) }}" onclick="return confirm('Ingin Menghapus Data?')">
