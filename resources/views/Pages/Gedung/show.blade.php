                ...
                <table id="table-show" class="table table-bordered table-striped" style="font-size: 15px;">
                    ...
                    <tbody class="text-capitalize">
                        ...
                        <tr>
                            ...
                            <td class="pt-3">{{ $row->kode_gedung }}</td>
                            <td class="pt-3">{{ $row->nama_gedung }}</td>
                            ...
                            <td class="text-center">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item btn" type="button" href="{{ route('warehouse.detail', $row->id_gedung) }}">
                                        <i class="fas fa-info-circle"></i> Detail
                                    </a>
                                    <a class="dropdown-item btn" type="button" href="{{ route('warehouse.edit', $row->id_gedung) }}">
                                        <i class="fas fa-edit"></i> Edit
                                    </a>
                                    <a class="dropdown-item btn" type="button" href="{{ route('warehouse.delete', $row->id_gedung) }}" onclick="return confirm('Ingin Menghapus Data?')">
