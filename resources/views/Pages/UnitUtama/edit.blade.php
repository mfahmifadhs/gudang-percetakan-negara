...
<section class="content">
    <div class="container">
        ...
        <div class="card card-warning card-outline">
            ...
            <form action="{{ route('mainunit.edit', $mainunit->id_unit_utama) }}" method="POST">
                @csrf
                <div class="card-body">
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label">Kode Unit Utama</label>
                        <div class="col-md-4">
                            <input type="text" class="form-control" name="kode_unit_utama" value="{{ $mainunit->kode_unit_utama }}" placeholder="Kode Unit Utama" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label">Nama Unit Utama</label>
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="nama_unit_utama" value="{{ $mainunit->nama_unit_utama }}" placeholder="Nama Unit Utama" required>
                        </div>
                    </div>
                </div>
