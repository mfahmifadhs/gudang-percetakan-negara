                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">{{ $item->tahun_perolehan }}</div>
                            <label class="col-md-3">{{ $item->jenis_barang_id == 441 ? 'NUP' : 'Masa Kadaluarsa' }}</label>:
                            <div class="col-md-8">{{ $item->catatan }}</div>
                            <label class="col-md-3">{{ $item->jenis_barang == 441 ? 'Proses Penghapusan' : 'Rencana Distribusi' }}</label>:
                    ...
                    <div class="col-md-4">
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">{{ $item->jumlah_diterima.' '.$item->satuan }}</div>
