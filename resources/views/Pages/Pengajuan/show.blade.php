                ...
                <table id="table-show" class="table table-bordered table-striped text-center" style="font-size: 15px;">
                    <thead class="text-center">
                        <tr>
                            ...
                            <th>Perihal</th>
                            <th>Keterangan</th>
                            <th style="width: 0%;">Total Barang</th>
                            <th style="width: 15%;">Proses <br> Pengajuan</th>
                            <th style="width: 0%;">Surat Pengajuan</th>
                            <th style="width: 0%;">Surat Perintah</th>
                            <th>Aksi</th>
                        </tr>
                    </thead>
                    @php $no = 1; @endphp
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="pt-3">{{ $row->tanggal_pengajuan }}</td>
                            ...
                            <td class="pt-3">
                                {{ $row->jenis_pengajuan == 'masuk' ? count($row->penyimpanan) : count($row->pengambilan) }}
                            </td>
                            <td class="pt-3">
                            ...
                            <td class="pt-3">{{ $row->surat_pengajuan ? '✅' : '❌' }} </td>
                            <td class="pt-3">{{ $row->surat_perintah ? '✅' : '❌' }} </td>
                            <td>
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    @if (Auth::user()->pegawai->workunit->id_unit_kerja == $row->unitkerja->id_unit_kerja && Auth::user()->role_id == 4 && $row->status_proses_id == 1)
