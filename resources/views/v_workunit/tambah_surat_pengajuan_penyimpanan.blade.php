          ...
          <div class="h-100">
            ...
            <div>
              <form action="{{ url('unit-kerja/surat/tambah-pengajuan/penyimpanan') }}" method="POST" enctype="multipart/form-data">
                ...
                <input type="hidden" name="id_appletter" value="{{ random_int(100000, 999999) }}">
                <div class="row g-4">
                  <div class="col-md-6">
                  ...
                  <div class="col-md-12">
                    <div class="form-floating">
                      <textarea type="text" id="summernote" class="form-control" name="text" placeholder="Maksud / Tujuan" required></textarea>
                  ...
                  <div class="col-md-12 mb-4" data-wow-delay="0.3s">
                    <div class="causes-item d-flex flex-column bg-light border-top border-5 border-primary rounded-top overflow-hidden h-100">
                      <div class="text-center p-4 pt-4">
                          <p>Silahkan mengisi informasi barang yang akan disimpan dengan download format file <a href="{{ asset('format_data_barang.xlsx') }}" download>disini</a> dan upload file informasi barang yang telah diisi.</p>
                        <div class="form-floating">
                          <input type="file" class="form-control" name="upload" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" name="category" placeholder="Upload Barang" required>
